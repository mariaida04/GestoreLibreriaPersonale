...
public class Prova {
    ...
    public static void main (String[] args) {
            /*
            Libro l1 = new Libro.Builder("Piccole Donne","Louisa May Alcott","858443385").stato(StatoLettura.COMPLETATO).valutazione(Valutazione.CINQUE_STELLE).genere("Fantasy")
                    .build();
            Libro l2 = new Libro.Builder("Il piccolo principe","Antoine de Saint-Exupéry","858448785").stato(StatoLettura.COMPLETATO).valutazione(Valutazione.DUE_STELLE).genere("Romanzo bambini")
                .build();
            ...
            Libro l5 = new Libro.Builder("La coscienza di Zeno","George Orwell","85993148785").stato(StatoLettura.DA_LEGGERE).valutazione(Valutazione.QUATTRO_STELLE).genere("Romanzo")
                    .build();
            Libro l6 = new Libro.Builder("La divina commedia","Dante Alighieri","8599148785").stato(StatoLettura.COMPLETATO).valutazione(Valutazione.DUE_STELLE).genere("Classico")
                    .build();
            Libro l7 = new Libro.Builder("Il codice da Vinci","Dan Brown","859913476585").stato(StatoLettura.IN_LETTURA).valutazione(Valutazione.UNA_STELLA).genere("Thriller")
                    .build();
            Libro l8 = new Libro.Builder("Harry Potter","Dan Brown","85991341377885").stato(StatoLettura.COMPLETATO).valutazione(Valutazione.UNA_STELLA).genere("Thriller")
                    .build();
